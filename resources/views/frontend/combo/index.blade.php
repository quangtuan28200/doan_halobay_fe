                                ...
                                <div class="dropdown-menu dropdown-select-option smooth-transition radius-md shadow-sm p-0" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <div class="dropdown-item border-0 px-3 d-flex justify-content-between bg-white">
                                        ...
                                        <span class="input-group-select d-flex align-items-center justify-content-end">
                                            ...
                                            <input type="number" min="0" value="{{ $info['combo_adultNum'] }}" class="input-step-fill person-number-item font-15pt border-0 bg-transparent no-active-focus text-center w-20 mx-3">
                                    ...
                                    <div class="dropdown-item border-0 px-3 d-flex justify-content-between bg-white">
                                        ...
                                        <span class="input-group-select d-flex align-items-center justify-content-end">
                                            <div class="step-minus cursor-pointer disable-click"><i class="fal fa-minus-circle"></i></div>
                                            <input type="number" min="0" value="{{ $info['combo_childNum'] }}" class="input-step-fill person-number-item font-15pt border-0 bg-transparent no-active-focus text-center w-20 mx-3">
                                            <div class="step-plus cursor-pointer"><i class="fal fa-plus-circle"></i></div>
                                        </span>
                                    </div>
                                    <div class="dropdown-item border-0 px-3 d-flex justify-content-between bg-white">
                                        ...
                                        <span class="input-group-select d-flex align-items-center justify-content-end">
                                            <div class="step-minus cursor-pointer disable-click"><i class="fal fa-minus-circle"></i></div>
                                            <input type="number" min="0" value="{{ $info['combo_childNum2'] }}" class="input-step-fill person-number-item font-15pt border-0 bg-transparent no-active-focus text-center w-20 mx-3">
                                            <div class="step-plus cursor-pointer"><i class="fal fa-plus-circle"></i></div>
                                        </span>
                                    </div>
                            ...
                            <div class="input-group float-label-input">
                                ...
                                <label class="matter-textfield-filled select-matter form-control d-block h-auto p-0 mb-0">
                                    ...
                                    <select class="selectpicker form-control h-auto py-12px bg-white" data-live-search="true" name="combo_place_end">
                                        ...
                                        <option value="{{ $place_tour->id }}" @if ($place_tour->id == $info['combo_place_end']) selected @endif>{{ $place_tour->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </label>
                        ...
                        <div class="form-group mb-0">
                            <div class="input-group float-label-input">
                                ...
                                <label class="matter-textfield-filled form-control d-block h-auto p-0 mb-0">
                                    <input type="text" placeholder=" " class="text-primary date-picker-tour" name="combo_date" value="{{ $info['combo_date'] }}">
                            ...
                            <div class="input-group float-label-input">
                                ...
                                <label class="matter-textfield-filled select-matter form-control d-block h-auto p-0 mb-0">
                                    ...
                                    <select class="selectpicker form-control h-auto py-12px bg-white" data-live-search="true" name="combo_place_start">
                                        @if ($list_place_tour)
                                        @foreach ($list_place_tour as $place_tour)
                                        <option value="{{ $place_tour->id }}" @if ($place_tour->id == $info['combo_place_start']) selected @endif>{{ $place_tour->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </label>
