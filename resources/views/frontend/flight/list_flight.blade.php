                ...
                <div class="row row-medium-space">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="dropdown dropdownPersonRoom ml-auto d-inline-block mb-3">
                            <button class="btn bg-transparent p-0 border-0 no-active-focus text-success" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="airplane-ticket-type">Khứ hồi</span>
                                <i class="fal fa-chevron-down text-success ml-1 mr-3"></i>
                                <span class="total-person">1</span> người lớn,
                            ...
                            <div class="dropdown-menu dropdown-select-option smooth-transition radius-md shadow-sm p-0" aria-labelledby="dropdownMenuButton">
                                ...
                                <div class="dropdown-item border-0 px-3 d-flex justify-content-between bg-white">
                                    ...
                                    <span class="input-group-select d-flex align-items-center justify-content-end">
                                        <div class="step-minus cursor-pointer"><i class="fal fa-minus-circle"></i></div>
                                        <input type="number" min="0" value="{{ $info['two_way_chd'] }}" name="two_way_chd" class="input-step-fill person-number-item font-15pt border-0 bg-transparent no-active-focus text-center w-20 mx-3">
                                        <div class="step-plus cursor-pointer"><i class="fal fa-plus-circle"></i></div>
                                    </span>
                                </div>
                                <div class="dropdown-item border-0 px-3 d-flex justify-content-between bg-white">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        <div class="row row-medium-space airplane-select-datetime">
                            <div class="col-sm-12 col-md-12 col-lg-4 mb-xs-3 mb-sm-3">
                                <div class="form-group mb-0">
                                    <div class="input-group float-label-input">
                                        <div class="input-group-prepend m-0">
                                            <span class="input-group-text bg-transparent pr-0 border-right-0">
                                        ...
                                        <label class="matter-textfield-filled form-control d-block h-auto p-0 mb-0">
                                            <input type="text" placeholder=" " value="{{ $info['two_way_start_date'] }}" class="text-primary date-range-airplane-twoway" required name="two_way_start_date">
                                            <span>Ngày đi</span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-4 mb-xs-3 mb-sm-3">
                                <div class="form-group mb-0">
                                    <div class="input-group float-label-input">
                                        ...
                                        <label class="matter-textfield-filled form-control d-block h-auto p-0 mb-0">
                                            <input type="text" placeholder=" " value="{{ $info['two_way_end_date'] }}" class="text-primary date-airplane" required name="two_way_end_date">
                                            <span>Ngày về</span>
                                        </label>
                                    </div>
                                </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-8 col-lg-9 combo-booking-list-left">
                ...
                <!-- <div class="search-result d-sm-flex d-md-flex d-lg-flex d-xl-flex align-items-center justify-content-between py-3">
                    <div>1002 Kết quả tìm kiếm</div>
                    <div>Giá cơ bản cho một người lớn</div>
                </div> -->
               
                <div class="row list-airplane row-small-space" id="data_flight">
                                                        ...
                                                        <div class="airplane-item-content d-flex align-items-center justify-content-between flex-wrap bg-gray-gradient pr-1">
                                                            ...
                                                            <div class="w-85 d-flex align-items-center justify-content-between flex-wrap airplane-ticket-info">
                                                                ...
                                                                <div class="text-right align-middle py-0 px-1 pr-xs-0 pr-sm-0 w-15">
                                                                    <a href="javascript:void(0)" class="btn btn-primary-gradient m-lg-0 mr-1 font-12pt check-air_plane" data-session="{{ $session }}" data-value="{{ $flight->listFlight[0]->flightValue }}" data-faredataid="{{ $flight->fareDataId }}">Chọn</a>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="card-body border p-0">
                                <nav class="border-top">
                                    <div class="nav nav-tabs airplane-ticket-return-nav flex-nowrap" role="tablist">
                                        ...
                                        <a class="nav-link text-center border-0 rounded-0 font-12pt px-2 py-1 @if ($list_day['status'] == 1) active @endif change_return_day_flight" href="javascript:void(0)" data-value="{{ $list_day['full_day'] }}">
                                            <div>{{ $list_day['stuff'] }}</div>
                                            <div>Ngày {{ $list_day['day'] }}</div>
                                            <div style="color: red;">{{ $list_day['min_price'] ? $list_day['min_price'] . VND : "" }} </div>
                                        </a>
                                                    ...
                                                    <div class="airplane-item font-14pt">
                                                        <div class="airplane-item-content d-flex align-items-center justify-content-between flex-wrap bg-gray-gradient pr-1">
                                                            ...
                                                            <div class="w-85 d-flex align-items-center justify-content-between flex-wrap airplane-ticket-info">
                                                                ...
                                                                <div class="text-right align-middle py-0 px-1 pr-xs-0 pr-sm-0 w-15">
                                                                    <a href="javascript:void(0)" class="btn btn-primary-gradient m-lg-0 mr-1 font-12pt check-air_plane_two" data-session="{{ $session }}" data-value="{{ $flight->listFlight[0]->flightValue }}" data-faredataid="{{ $flight->fareDataId }}">Chọn</a>
                                                                </div>
                                                            </div>
                                                        </div>
...
<script>
    const load_data_flight = function (params) {
        ...
        $.ajax({
            ...
            data: {
                ...
                two_way_chd:params['two_way_chd'], 
                two_way_inf:params['two_way_inf'], 
                begin_place_2_way:params['begin_place_2_way'], 
                end_place_2_way:params['end_place_2_way'],
                two_way_start_date:params['two_way_start_date'],
                two_way_end_date:params['two_way_end_date'],
    ...
    $('body').on('click', '.orderBy', function () {
        ...
        const two_way_end_date =$('input[name=two_way_end_date_hide]').val();
        load_data_flight({
            orderBy:orderBy, 
            timer:timer, 
            ...
            two_way_end_date:two_way_end_date,
            view_mode:view_mode
        })
    });
    ...
    $('body').on('click', '.change_return_day_flight', function () {
        const orderBy = $(this).val();
        let timer = 0;
        $.each($('.airplane-time-flight-item'), function(value, key) {
            if ($(this).hasClass('active')) timer = $(this).data('value');
        ...
        const end_place_2_way = $('input[name=end_place_2_way_hide]').val();
        const two_way_start_date = $('input[name=two_way_start_date_hide]').val();
        const two_way_end_date = $(this).data('value');
        load_data_flight({
            orderBy:orderBy, 
            timer:timer, 
            airline_company:airline_company, 
    ...
    $('body').on('click', '.check-air_plane', function () {
        ...
        $('.check-air_plane_two').each(function () {
            if ($(this).hasClass('is_check_air_flight')) {
                const session_two = $(this).data('session');
                const flight_value_two = $(this).data('value');
                const flight_id_two = $(this).data('faredataid');
                window.location.href = '{{ route('flight_booking') }}?form_session=' + session_one + '&form_value=' + flight_value_one + '&form_id=' + flight_id_one + '&to_session=' + session_two + '&to_value=' + flight_value_two + '&to_id=' + flight_id_two;
            }
        })
    });
    $('body').on('click', '.check-air_plane_two', function () {
        const _this = $(this);
        $('.show-detail-two').removeClass('show');
        $('.show-detail-two').addClass('hide');
        $('.check-air_plane_two').html('Chọn');
        $('.check-air_plane_two').removeClass('is_check_air_flight');
        _this.parent().parent().parent().next().removeClass('hide');
        _this.parent().parent().parent().next().addClass('show');
        _this.html('<i class="fas fa-check"></i>');
        _this.addClass('is_check_air_flight');
        const session_two = _this.data('session');
        const flight_value_two = _this.data('value');
        const flight_id_two = _this.data('faredataid');
        $('.check-air_plane').each(function () {
            if ($(this).hasClass('is_check_air_flight')) {
                const session_one = $(this).data('session');
                const flight_value_one = $(this).data('value');
                const flight_id_one = $(this).data('faredataid');
                window.location.href = '{{ route('flight_booking') }}?form_session=' + session_one + '&form_value=' + flight_value_one + '&form_id=' + flight_id_one + '&to_session=' + session_two + '&to_value=' + flight_value_two + '&to_id=' + flight_id_two;
            }
        })
    });
