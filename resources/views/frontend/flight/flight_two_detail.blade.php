...
<section class="combo-booking-list">
    <div class="airplane-booking-info py-3">
        <div class="container">
            <form action="{{ route('book_flight_two') }}" method="POST">
                {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-8 col-lg-9 airplane-booking-info-left">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="airplane-info-detail w-100">
                                    <div class="airplane-ticket-info-header w-100 bg-white mb-5px">
                                        ...
                                        <input type="hidden" name="flight_value_two" value="{{ $flight_two->listFareData[0]->listFlight[0]->flightValue }}">
                                        <input type="hidden" name="flight_id_two" value="{{ $flight_two->listFareData[0]->fareDataId }}">
                                        <input type="hidden" name="flight_leg_two" value="{{ $flight_two->listFareData[0]->leg }}">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="airplane-info-detail w-100">
                                    <div class="airplane-ticket-info-header w-100 bg-white mb-5px">
                                        <div class="d-flex align-items-center justify-content-between p-2">
                                            <div class="text-center d-flex align-items-center flex-wrap">
                                                <div class="font-title">{{ $lists[1]['startPoint'] }}</div>
                                                <img src="{{ asset('frontend/img/airplane-icon.png') }}" class="img-fluid mx-4" width="25">
                                                <div class="font-title">{{ $lists[1]['endPoint'] }}</div>
                                            </div>
                                            <img src="{{ asset($lists[1]['logo']) }}" class="img-fluid" width="100">
                                        </div>
                                        <div class="airplane-ticket-sub-info d-flex align-items-center justify-content-between w-100 p-2 bg-white">
                                            <span>{{ Carbon\Carbon::parse($lists[1]['start_date'])->format('d/m/Y') }}</span>
                                            <span>{{ Carbon\Carbon::parse($lists[1]['start_date'])->format('H:i') }}</span>
                                            <span>{{ $lists[1]['flightNumber'] }}</span>
                                        </div>
                                    </div>
                                    <div class="airplane-ticket-info-body w-100">
                                        <div class="airplane-ticket-info-item w-100 d-flex align-items-center justify-content-between bg-white mb-5px p-2">
                                            <span>Giá vé người lớn</span>
                                            <span class="font-title-bold">{{ number_format($flight_two->listFareData[0]->fareAdt, 0, ',', '.') }} VND</span>
                                        </div>
                                        <div class="airplane-ticket-info-item w-100 d-flex align-items-center justify-content-between bg-white mb-5px p-2">
                                            <span>Giá vé trẻ em</span>
                                            <span class="font-title-bold">{{ number_format($flight_two->listFareData[0]->fareChd, 0, ',', '.') }} VND</span>
                                        </div>
                                        <div class="airplane-ticket-info-item w-100 d-flex align-items-center justify-content-between bg-white mb-5px p-2">
                                            <span>Giá vé em bé</span>
                                            <span class="font-title-bold">{{ number_format($flight_two->listFareData[0]->fareInf, 0, ',', '.') }} VND</span>
                                        </div>
                                        <div class="airplane-ticket-info-item w-100 d-flex align-items-center justify-content-between bg-white mb-5px p-2">
                                            <span>Thuế + phí</span>
                                            <span class="font-title-bold">{{ number_format($flight_two->total_fee_service, 0, ',', '.') }} VND</span>
                                        </div>
                                        <div class="airplane-ticket-info-item w-100 d-flex align-items-center justify-content-between bg-white mb-5px p-2">
                                            <span>Hành Lý / {{ $flight_two->listFareData[0]->listFlight[0]->listSegment[0]->handBaggage }}</span>
                                            <span class="font-title-bold">Miễn phí</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- <div class="row airplane-contact-info row-small-space">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="font-title font-22pt py-3">Thông tin khách hàng</div>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                <div class="form-group mb-5px">
                                    <input type="text" class="form-control py-12px h-auto border-0" placeholder="Nhập số người lớn">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                <div class="form-group mb-5px">
                                    <input type="text" class="form-control py-12px h-auto border-0" placeholder="Nhập số trẻ em">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                <div class="form-group mb-0">
                                    <input type="text" class="form-control py-12px h-auto border-0" placeholder="Nhập số trẻ nhỏ">
                                </div>
                            </div>
                        </div> -->
                        <div class="placeholder-color list-user-info">
                            @for ($i=0; $i < $flight_two->listFareData[0]->adt; $i ++)
                            <div class="row row-small-space user-info-item">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <div class="font-title font-22pt py-3">Người lớn 1</div>
                                </div>
                                <div class="col-sm-12 col-md-3 col-lg-3">
                                    <div class="form-group mb-5px">
                                ...
                                <!-- <div class="col-sm-12 col-md-6 col-lg-6 mb-5px">
                                    <div class="input-group">
                                        <input type="number" class="form-control border-0 h-auto no-active-focus py-12px" placeholder="Điện thoại" name="phone_number[]">
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-lg-6 mb-5px">
                                    <div class="input-group">
                                        <input type="email" class="form-control border-0 h-auto no-active-focus py-12px" placeholder="Email" name="email[]">
                                    </div>
                                </div> -->
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group mb-5px">
                                        <select class="form-control h-auto py-12px bg-white add_handbags" name="handbags_one[]">
                                            <option data-price="0" value="0">Hành lý ký gửi chuyển đi</option>
                                            @if ($hand_bag_one->message == " " || $hand_bag_one->message == null)
                                            @foreach ($hand_bag_one->listBaggage as $list)
                                            <option data-price="{{ $list->Price }}" value="{{ $list->Airline . '-' . $list->Leg . '-' . $list->Route . '-' . $list->Code . '-' . $list->Currency . '-' . $list->Name . '-' . $list->Price . '-' . $list->Value }}">{{ $list->Name . ' (' . number_format($list->Price, 0, ',', '.') . ' VND)' }}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group mb-0">
                                        <select class="form-control h-auto py-12px bg-white add_handbags_two" name="handbags_two[]">
                                            <option data-price="0" value="0">Hành lý ký gửi chuyển về</option>
                                            @if ($hand_bag_two->message == " " || $hand_bag_two->message == null)
                                            @foreach ($hand_bag_two->listBaggage as $list)
                                            <option data-price="{{ $list->Price }}" value="{{ $list->Airline . '-' . $list->Leg . '-' . $list->Route . '-' . $list->Code . '-' . $list->Currency . '-' . $list->Name . '-' . $list->Price . '-' . $list->Value }}">{{ $list->Name . ' (' . number_format($list->Price, 0, ',', '.') . ' VND)' }}</option>
                                            @endforeach
                                            @endif
                                        </select>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-3 airplane-booking-right">
                        <div class="payment-info">
                            ...
                            <div class="payment-info-body">
                                <ul class="list-group">
                                    ...
                                    <div class="py-2 px-3 font-title bg-white">Giá vé chuyến về</div>
                                    <li class="list-group-item font-15pt d-flex align-items-center justify-content-between border-0 py-2 px-3 mt-1 mb-5px">
                                        <div>Giá vé người lớn</div>
                                        <div>{{ number_format($flight_two->listFareData[0]->fareAdt, 0, ',', '.') }} VND</div>
                                    </li>
                                    <li class="list-group-item font-15pt d-flex align-items-center justify-content-between border-0 py-2 px-3 mb-5px">
                                        <div>Giá vé trẻ em</div>
                                        <div>{{ number_format($flight_two->listFareData[0]->fareChd, 0, ',', '.') }} VND</div>
                                    </li>
                                    <li class="list-group-item font-15pt d-flex align-items-center justify-content-between border-0 py-2 px-3 mb-5px">
                                        <div>Giá vé em bé</div>
                                        <div>{{ number_format($flight_two->listFareData[0]->fareInf, 0, ',', '.') }} VND</div>
                                    </li>
                                    <li class="list-group-item font-15pt d-flex align-items-center justify-content-between border-0 py-2 px-3 mb-5px">
                                        <div>Thuế phí</div>
                                        <div>{{ number_format($flight_two->total_fee_service, 0, ',', '.') }} VND</div>
                                    </li>
                                    <li class="list-group-item font-15pt d-flex align-items-center justify-content-between border-0 py-2 px-3 mb-5px">
                                        <div>Hành lý / {{ $flight_two->listFareData[0]->listFlight[0]->listSegment[0]->handBaggage }}</div>
                                        <div>Miễn phí</div>
                                    </li>
                                </ul>
                            </div>
                            <div class="paymanet-info-footer">
                                <div class="d-flex align-items-center bg-white justify-content-between mb-1 py-2 px-3">
                                    <div>Tổng</div>
                                    <div class="text-success font-title total" data-price="{{ $flight_one->total + $flight_two->total }}">{{ number_format(($flight_one->total + $flight_two->total), 0, ',', '.') }} </div>
                                </div>
                        ...
                        <div class="payment-info mb-1">
                            <div class="payment-info-header">
                                <div class="font-title p-3 bg-white text-center font-18pt border-bottom">Điều kiện vé </div>
                            </div>
                        ...
                        <!-- <div class="payment-info">
                            <div class="payment-info-header">
                                <div class="font-title p-3 bg-white text-center font-18pt border-bottom">Điều kiện vé chuyến về</div>
                            </div>
                            <div class="payment-info-body p-3 bg-white">
                                <p class="mb-0">Hoàn Vé: Không được phép Đối Tên Hành Khách: Được phép - Thơ phí: 374.000 VND + Giá vé chênh lệch (nếu có) Đổi Hành Trình: Được phép - Thu phí: 374.000 VND + Giá vé chênh lệch (nếu có).<br>Đổi đồng hàng hoặc nâng hạng. tương ứng của hành trình mới.<br> Đổi Ngày Giờ Chuyến Bay: Được phép - Thu phí: 374.000 VND + Giá vé chênh lệch (nếu có). <br>Bảo lưu: Không được phép Thời hạn thay đổi (bao gồm thay đổi tên, ngày/chuyến bay): Trước giờ khởi hành 12 tiếng.</p>
                            </div>
                        </div> -->
                    </div>
                </div>
...
@section('scripts')
<script>
    $('body').on('change', '.add_handbags, .add_handbags_two', function () {
        let total = $('.total').data('price');
        let price = 0;
        let price_two = 0;
        $('.add_handbags').each(function (key, value) {
            price = price + $('option:selected', value).data('price');
        })
        $('.add_handbags_two').each(function (key, value) {
            price_two = price_two + $('option:selected', value).data('price');
        })
        total = total + price + price_two;
        $('.total').html(accounting.formatMoney(total, '', 0, '.', ',') + ' VND');
    });
    // $('body').on('change', '.add_handbags_two', function () {
